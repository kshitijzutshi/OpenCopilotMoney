...
export const metadata = constructMetadata({
  title: "Blog - OpenCopilotMoney",
  description: "Insights, tutorials, and updates from the OpenCopilotMoney team. Learn how to optimize your link management strategy.",
});
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Insights, tutorials, and updates from the OpenCopilotMoney team. Learn how to
