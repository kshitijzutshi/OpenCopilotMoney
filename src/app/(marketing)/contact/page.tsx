        ...
        <div className="px-6 md:px-10 py-10 flex flex-col gap-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Get in touch for support, feedback, or questions about OpenCopilotMoney.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group p-8 border-r border-b border-border relative flex flex-col">
              ...
              <Button asChild className="w-fit">
                <a href={`mailto:${siteMetadata.links.email}`}>Get support</a>
              </Button>
            </div>
            ...
            <div className="group p-8 border-b border-border relative flex flex-col">
              ...
              <Button asChild className="w-fit">
                <a href={`mailto:${siteMetadata.links.email}?subject=Feedback`}>
                  Send Feedback
                </a>
              </Button>
            </div>
            ...
            <div className="group p-8 relative flex flex-col">
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-8">
                  Read about OpenCopilotMoney platform development and contribute to our
                  codebase.
                </p>
              </div>
              <Button asChild className="w-fit" variant="outline">
          ...
          <div className="text-center space-y-4 pt-8 border-t border-border">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <a
                  href={`mailto:${siteMetadata.links.email}`}
                  className="hover:text-primary transition-colors"
                >
                  {siteMetadata.links.email}
                </a>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={siteMetadata.links.twitter}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary transition-colors"
                >
